...
$sql="SELECT * FROM general_reservation WHERE agency = '$agency' ";
...
$( document ).ready(function() {
 ...
 $('#myModal').click(function(){
  ...
  <body>
    ...
    <?php echo "<b><center><h3>Reservations From $agency</h3></center></b><br>";
?>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Greater Accra Region' ") or die(mysqli_error($con));
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Eastern Region' ") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
            ...
            <td><textarea style="width: 180px" type="" name="comment[]" value="<?php echo $row['comment'];?>" readonly><?php echo $row['comment'];?></textarea></td>
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
            <a  data-toggle="modal" href="reservation-profile.php?id=<?php echo $reservation_id;?>" data-target="#myModal1" class="btn btn-link">Reserver's Profile</a></td>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Western Region' ") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
            ...
            <td><textarea style="width: 180px" type="" name="comment[]" value="<?php echo $row['comment'];?>" readonly><?php echo $row['comment'];?></textarea></td>
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
            <a  data-toggle="modal" href="reservation-profile.php?id=<?php echo $reservation_id;?>" data-target="#myModal2" class="btn btn-link">Reserver's Profile</a></td>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Central Region' ") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
            ...
            <td><textarea style="width: 180px" type="" name="comment[]" value="<?php echo $row['comment'];?>" readonly><?php echo $row['comment'];?></textarea></td>
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
            <a  data-toggle="modal" href="reservation-profile.php?id=<?php echo $reservation_id;?>" data-target="#myModal3" class="btn btn-link">Reserver's Profile</a></td>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Ashanti Region' ") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
            ...
            <td><textarea style="width: 180px" type="" name="comment[]" value="<?php echo $row['comment'];?>" readonly><?php echo $row['comment'];?></textarea></td>
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
            <a  data-toggle="modal" href="reservation-profile.php?id=<?php echo $reservation_id;?>" data-target="#myModal4" class="btn btn-link">Reserver's Profile</a></td>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Volta Region' ") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
            ...
            <td><textarea style="width: 180px" type="" name="comment[]" value="<?php echo $row['comment'];?>" readonly><?php echo $row['comment'];?></textarea></td>
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
            <a  data-toggle="modal" href="reservation-profile.php?id=<?php echo $reservation_id;?>" data-target="#myModal5" class="btn btn-link">Reserver's Profile</a></td>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Brong Ahafo Region' ") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
            ...
            <td><textarea style="width: 180px" type="" name="comment[]" value="<?php echo $row['comment'];?>" readonly><?php echo $row['comment'];?></textarea></td>
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
            <a  data-toggle="modal" href="reservation-profile.php?id=<?php echo $reservation_id;?>" data-target="#myModal6" class="btn btn-link">Reserver's Profile</a></td>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Northern Region' ") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
            ...
            <td><textarea style="width: 180px" type="" name="comment[]" value="<?php echo $row['comment'];?>" readonly><?php echo $row['comment'];?></textarea></td>
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
            <a  data-toggle="modal" href="reservation-profile.php?id=<?php echo $reservation_id;?>" data-target="#myModal7" class="btn btn-link">Reserver's Profile</a></td>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Upper East Region' ") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
            ...
            <td><textarea style="width: 180px" type="" name="comment[]" value="<?php echo $row['comment'];?>" readonly><?php echo $row['comment'];?></textarea></td>
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
            <a  data-toggle="modal" href="reservation-profile.php?id=<?php echo $reservation_id;?>" data-target="#myModal8" class="btn btn-link">Reserver's Profile</a></td>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM general_reservation WHERE agency = '$agency' AND region_name = 'Upper West Region' ") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
            ...
            <td><textarea style="width: 180px" type="" name="comment[]" value="<?php echo $row['comment'];?>" readonly><?php echo $row['comment'];?></textarea></td>
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
            <a  data-toggle="modal" href="reservation-profile.php?id=<?php echo $reservation_id;?>" data-target="#myModal9" class="btn btn-link">Reserver's Profile</a></td>
