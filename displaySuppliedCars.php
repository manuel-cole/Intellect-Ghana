...
$sql="SELECT * FROM supplied_reservation";
      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
            ...
            <a class="navbar-brand" href="car_company_page.php">IG Homepage</a>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM supplied_reservation") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
echo "<b><center><h3>Cars Supplied To Ministry</h3></center></b><br><br>";

while($row=mysqli_fetch_array($result)){
    $supplied_id = $row['supplied_id'];
    ?>
    <tr>
         <td><center><input type="checkbox" name="check[<?php echo $row['supplied_id'];?>]" value="1" ></center> </td>
            ...
            <td><p><strong>Name: </strong><?php echo $row['fname']?> <?php echo $row['lname']?></p>
                <a data-toggle="modal" href="supplied-profile.php?id=<?php echo $supplied_id;?>" data-target="#myModal" class="btn btn-link">Reserver's Profile</a></td>
