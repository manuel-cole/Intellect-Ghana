...
while($row=mysqli_fetch_array($result)) {
	...
	if (array_key_exists($approved_id, $_POST["check"])) {
		...
		if ($ischecked==1) {
			...
			$sql = "INSERT INTO unconfirmed_reservation (unconfirm_id, comment, car_type, trim, year_made, exterior_colour, options, km, quantity, fname, lname, mobile_number, agency)
...
<link rel="stylesheet" href="css/lightbox.css">
  ...
  <body>
    ...
    <div class="container">
        <div class="row">
            <div class="">     
             <center><h2> Car Reservation Disapproved Successfully..</h2></center>
            <br>  
