...
while($row=mysqli_fetch_array($result)) {
	...
	if (array_key_exists($reservation_id, $_POST["check"])) {
		...
		if ($ischecked==1) {
			...
			$sql = "INSERT INTO unapproved_reservation (unapproved_id, comment, car_type, trim, year_made, exterior_colour, options, km, region_name,quantity, fname, lname, mobile_number, agency)
