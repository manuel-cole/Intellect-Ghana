      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
		 ...
		 <!--<form class="navbar-form navbar-right">
		  ...
		  -->
		  <form id="form0" class="navbar-form navbar-right" onsubmit="return validateForm()" method='post' action="checklogin.php">
        <div class="form-group">
	    ...
	    <div class="form-group">
            ...
            <div class="btn-link" align="right";>Forget Password? </div>
			</a>
            <button name="signin" class="btn btn-lg btn-info btn-block" type="submit">Sign in</button>
